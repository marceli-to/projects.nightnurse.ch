...
<div v-if="isFetched" class="max-w-5xl">
    ...
    <feed>
      ...
      <div v-for="(items, day) in feedItems" :key="day" class="relative">
        ...
        <feed-item 
          ...
          :projectDeleted="project.is_deleted" 
  ...
  <content-footer v-if="!hasForm">
    <router-link :to="{ name: 'projects', params: { type: project.state.description == 'active' || project.state.description == 'concluded' ? 'active' : 'archived' } }" class="form-helper form-helper-footer">
